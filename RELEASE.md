...
4. 执行 `git add`（含 `RELEASE_NOTES.md` 与各 `package.json`）、`git commit -m "chore(release): vX.Y.Z"`、`git tag vX.Y.Z`  
5. 执行 `gh release create vX.Y.Z --notes-file RELEASE_NOTES.md`，在 GitHub 上创建 Release 并填入 Changelog  
