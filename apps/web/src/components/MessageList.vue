    ...
    <div class="max-w-3xl mx-auto">
      ...
      <Transition name="fade">
        <button
          ...
          class="fixed bottom-[184px] left-1/2 -translate-x-1/2 z-50 px-4 py-2 text-xs font-medium text-foreground bg-background border border-border rounded-lg shadow-lg flex items-center gap-2 hover:bg-muted transition-all duration-200 backdrop-blur-sm"
          @click="scrollToBottom(); userScrolledUp = false"
        >
          <div class="i-carbon-arrow-down h-3.5 w-3.5" />
          滚动到底部
        </button>
      </Transition>
    </div>
