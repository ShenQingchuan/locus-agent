...
export const askQuestionTool = tool({
  description: 'Ask the user one or more questions. Each question has up to 4 predefined options (the UI will also show a free-form custom input, so you do NOT need to include a catch-all option). Use this tool when you need clarification or decisions from the user before proceeding.',
