 ...
 *
 * Defines available LLM providers (OpenAI, Anthropic, etc.) and their metadata.
 * Use these types for selecting and configuring main language models.
 *
 * @module types/llm-provider
 */
...
export const LLM_PROVIDERS: LLMProviderMeta[] = [
  ...
  { value: 'zhipu', label: '智谱清言', icon: 'i-custom:zai', defaultModel: 'glm-5.1', defaultApiBase: 'https://open.bigmodel.cn/api/paas/v4' },
